...
Снимки `menu-assets.json`, `research-assets.json` и `buildable-defaults.json`
получены из assets и RU/EN локализации установленной сборки 24656030 (CL 502094).
Это компактные производные игровых данных, а не заимствованный код интерфейса.
Для извлечения использован CUE4Parse 1.2.2.202609 (Apache-2.0); его DLL,
зависимости и полные игровые пакеты в проект не включаются. Источники и SHA-256
сохранены в самих снимках и `packages/game-data/source/provenance.json`.
