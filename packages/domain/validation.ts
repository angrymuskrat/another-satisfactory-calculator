...
export const planSchema = z.strictObject({
  ...
  targets: z.array(z.strictObject({ itemId: id, rate: positive, weight: positive, scale: positive,
  ...
  sources: z.array(z.strictObject({
    id, name: z.string().max(120).optional(), itemId: id, kind: z.enum(['flow', 'node']), limit: quantity.nullable(),
